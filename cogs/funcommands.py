...
class Fun_Commands(commands.Cog):
	...
	@commands.command(name="boykisser", description="Sends a random boykisser")
	...
	@commands.command(description="Sends the Home Depot logo")
	...
	@commands.command(description="Sends a 7 (seven)")
	...
	@commands.command(description="Sends a rickroll")
